...
export const AboutPage = () => {
  return (
    <div className="min-h-screen bg-[#FFFDF7] dark:bg-[#091B29] text-slate-900 dark:text-slate-100 transition-colors duration-200">
      {/* Top Simple Header */}
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4">
          <Link
            to="/"
            className="text-xs font-bold text-slate-700 dark:text-slate-200 hover:text-[#087F8C] transition-colors"
          >
            Home
          </Link>
          <Link
            to="/login"
            className="px-4 py-2 bg-gradient-to-r from-orange-500 to-[#EA580C] hover:from-orange-600 hover:to-[#EA580C] text-white text-xs font-bold rounded-xl shadow-xs transition-all"
          >
            Login
          </Link>
        </div>
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="p-6 bg-white dark:bg-[#0F273D] border border-slate-200/80 dark:border-slate-800 rounded-3xl space-y-3 shadow-sm">
          ...
          <div className="p-6 bg-white dark:bg-[#0F273D] border border-slate-200/80 dark:border-slate-800 rounded-3xl space-y-3 shadow-sm">
            <div className="w-12 h-12 rounded-2xl bg-teal-500/15 text-[#087F8C] dark:text-[#27B7A8] flex items-center justify-center">
        ...
        {/* CTA */}
        <div className="p-8 sm:p-12 bg-gradient-to-r from-[#091B29] via-[#0F273D] to-[#091B29] rounded-3xl text-white text-center space-y-4 shadow-xl border border-teal-500/30">
          ...
          <div className="flex justify-center gap-3 pt-2">
            <Link
              to="/register"
              className="px-6 py-3 bg-gradient-to-r from-orange-500 to-[#EA580C] hover:from-orange-600 hover:to-[#EA580C] text-white text-xs font-bold rounded-xl shadow-md transition-all"
            >
              Get Started
            </Link>
            <Link
